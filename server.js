 ...
 *      responses:
 *          200:
 *              description: JSON bbject containing array of student objects
 */
 ...
 * /customers:
 *    get:
 *      description: Returns all the records from the Customer table
 *      produces:
 *          - application/json
 *      responses:
 *          200:
 *              description: JSON bbject containing array of customer objects
 */
 ...
 *
 */
app.post(('/companies'),[ check('COMPANY_ID','Company ID is required').not().isEmpty().trim(),
 ...
 *
 */
app.put(('/companies/:COMPANY_ID'),[ check('COMPANY_NAME','Company NAME is required').not().isEmpty().trim(),
          check('COMPANY_CITY','Company CITY is Required').not().isEmpty().trim()],async (req,res) => {
     const errors = validationResult(req);
     if (!errors.isEmpty()) {
      	return res.status(400).send(errors);
     }
